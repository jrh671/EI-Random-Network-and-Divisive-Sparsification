function [spike_rate_matrix] = SlidingAverage_s_mean(spike_matrix,UpdatePeriod)
...
% Parameters
bin_duration = UpdatePeriod; % 7ms bins
...
for row = 1:num_rows
    for col = 1:num_columns
        ...
        spike_rate_matrix(row, col) = mean(spike_matrix(row, start_idx:end_idx)) ;
    end
end
end