...
for idx = 1:numFiles
    ...
    filePath = sprintf('/Users/josehurtado/Documents/MATLAB/Final_Manuscript/Random_EIPlaceNet_Internal/Supplementary/S4_5/Data/%d.mat', i);
...
if PlotFigure == 1
    % Initialize cell arrays to collect data
    CollectReverse = cell(1, 12);
    CollectFreeze = cell(1, 12);
