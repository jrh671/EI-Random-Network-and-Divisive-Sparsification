...
SheetTagA=[x1_c1,y1_c1];
SheetTagB=[y2_c2,x2_c2];
...
SheetTagA=[y1_c1,x1_c1];
SheetTagB=[x2_c2,y2_c2];
...
SheetTagAToA=diff_context1_epoch4;
SheetTagAToB=diff_context1_epoch6;
SheetTagBToB=diff_context2_epoch4;
SheetTagBToA=diff_context2_epoch6;
