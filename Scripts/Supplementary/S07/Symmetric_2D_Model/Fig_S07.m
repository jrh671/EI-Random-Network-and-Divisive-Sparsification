...
VisualizePlasticity=0; % To Visualize Plasticity (1) OR Anti-CoFiring Stats (0)

%% These are preset environments determined by the random tuning seeds.

AAB=1; %1 = No intermediate remapping. 0 = With intermediate remapping
PairID=1; %Sorted by anti-cofiring context specificty 

if AAB==1
   load('/Users/josehurtado/Documents/MATLAB/Final_Manuscript/Random_EIPlaceNet_Data/Supplementary/S07/Symmetric_2D_Model/PreRun_Data/StoreMemory_AAB.mat', ...
       'TopPairs_AAB'); 
    TopPairs=TopPairs_AAB;
else
   load('/Users/josehurtado/Documents/MATLAB/Final_Manuscript/Random_EIPlaceNet_Data/Supplementary/S07/Symmetric_2D_Model/PreRun_Data/StoreMemory_ABA.mat', ...
       'TopPairs_ABA'); 
...
for Context = ContextGoal
    ...
    for Epoch = Epochs
        ...
        % Chosen neurons for visualization 
          Choose2NeuronsCA3=[2,3];% [6,10] and [8,53] . [6,10,15,18,19,38,66]

        % Define special location and radius
        special_location = [9, 1];
