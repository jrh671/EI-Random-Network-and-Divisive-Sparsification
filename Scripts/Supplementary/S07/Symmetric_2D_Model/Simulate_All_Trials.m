...
if AAB == 1
    save('/Users/josehurtado/Documents/MATLAB/Final_Manuscript/Random_EIPlaceNet_Internal/Supplementary/S07/Symmetric_2D_Model/PreRun_Data/StoreMemory_AAB.mat', ...
         'StoreMemoryCells', 'StoreNonMemoryCells', 'pairs');
end

if AAB == 0
    save('/Users/josehurtado/Documents/MATLAB/Final_Manuscript/Random_EIPlaceNet_Internal/Supplementary/S07/Symmetric_2D_Model/PreRun_Data/StoreMemory_ABA.mat', ...
         'StoreMemoryCells', 'StoreNonMemoryCells', 'pairs');
end
