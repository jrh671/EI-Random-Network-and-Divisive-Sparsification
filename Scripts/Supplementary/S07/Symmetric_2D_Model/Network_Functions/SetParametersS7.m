if Plasticity == 1
    ...
    thresholdCA3 = 0.75; % Activity threshold
    if special_radius<1
        threshold_goalCA3 = 10000;
    else
        disp('Goal On')
        threshold_goalCA3 = 0.5;
    end
...
WeightScaleCA3 = 0.025;
WeightCAMKII = 2;
WeightUpdatePlusCA3 = 0.001;   % Weight scale for updates
WeightUpdateMinusCA3 = 0.001;   % Weight scale for updates
CA3Sparsity=0;
