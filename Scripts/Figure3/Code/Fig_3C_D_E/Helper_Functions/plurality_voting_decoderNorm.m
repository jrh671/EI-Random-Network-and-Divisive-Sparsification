function [DE, neu_votes, decoded_positions] = plurality_voting_decoderNorm(Spikes, SpikesTrain, Positions, excluded_p)
    ...
    Spikes_first_half = SpikesTrain(:, 1:(num_bins/2));
