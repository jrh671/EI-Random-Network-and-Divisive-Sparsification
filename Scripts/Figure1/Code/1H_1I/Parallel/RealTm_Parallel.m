...
% Now you can save the results outside the parfor loop
    ...
    filename = sprintf('/mnt/home/jhurtado/ceph/resultsFast.mat');
    % Save the results
    save(filename, 'results');

        % Construct a unique filename for each iteration
    filename2 = '/mnt/home/jhurtado/ceph/W_InputEFast.mat';
    % Save the results
    save(filename2, 'W_inputECell');

    % Construct a unique filename for each iteration
    filename3 = '/mnt/home/jhurtado/ceph/PF_CellFast.mat';
    % Save the results
