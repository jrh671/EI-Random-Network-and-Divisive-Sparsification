function [NS,ordered] = Compute_RateMap(Data,positions)
...
figure;imagesc(NS(Ordering,:),[0,1]);title('Position Ave Membrane Potential'); xlabel('Position');ylabel('Neuron (Sorted)'); colormap("hot");
