...
input_neurons = pf_cellC; % 1x1000 cell array, each cell contains a vector of positions
weight_matrix = W_inputECell{1}; % 1000x500 matrix with random connection strengths
